...
var component = normalizeComponent(
  ...
  ActionbarBuildvue_type_template_id_18ea5cda_render,
  staticRenderFns,
  false,
  null,
  null,
...
var ActionbarJustCompile_component = normalizeComponent(
  ...
  ActionbarJustCompilevue_type_template_id_04aa2427_render,
  ActionbarJustCompilevue_type_template_id_04aa2427_staticRenderFns,
  false,
  null,
  null,
  null
...
/* harmony default export */ var ActionbarSettingvue_type_script_lang_js_ = ({
  data: function data() {
    return {
      ...
      baudrates: [921600, 115200, 256000, 230400, 512000],
  ...
  watch: {
    ...
    currentPort: function currentPort(port) {
      console.log("currentrt changed. HONEYLemon Board to ".concat(port)); //this.$global.board.package["arduino-esp32-actionbar"].comport = this.comports[0];
...
var ActionbarSetting_component = normalizeComponent(
  ...
  ActionbarSettingvue_type_template_id_90b11412_render,
  ActionbarSettingvue_type_template_id_90b11412_staticRenderFns,
  false,
  null,
  null,
  null
